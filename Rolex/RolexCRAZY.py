...
import time
import math
import os  # ✅ For absolute path handling
...
class Clock:
    ...
    def draw_center_ovals(self):
        ...
        # 🔴 Red seconds pivot (small topmost dot)
        self.canvas.create_oval(x0-7, y0-7, x0+7, y0+7, fill='red', outline='black', width=2, tags='center_dot')
    ...
    def draw_second_hand(self):
        ...
        # Second hand (black underlay + white overlay)
        ...
        # Small tip oval at the end of the second hand
    ...
    def update_second_hand(self):
        ...
        self.canvas.tag_raise('center_dot')  # 🔼 Always keep center (and red dot) on top
