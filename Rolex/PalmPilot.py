...
class Clock:
    ...
    def draw_hands(self, hour, minute):
        ...
        self.canvas.create_line(
            ...
            fill='gray30', width=9, capstyle=tk.ROUND, tags='main_hands'
        )
    ...
    def draw_second_hand(self):
        ...
        self.canvas.create_line(second_center_x, second_center_y, second_x, second_y, width=8, fill='white', capstyle=tk.ROUND, tags='second_hand')
