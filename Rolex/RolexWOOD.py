...
class Clock:
    def __init__(self):
        ...
        self.background_image = tk.PhotoImage(file=os.path.join(base_path, "RolexWOOD.png"))
        self.weekday_images = {
    ...
    def draw_date(self, day, weekday):
        self.canvas.create_image(980, 148, image=self.weekday_images[weekday], anchor='center')
        self.canvas.create_text(1387, 634, text=day, font=('Copperplate', 64), fill='black')
        self.canvas.create_text(1385, 632, text=day, font=('Copperplate', 64), fill='#FCF2E3', anchor='center')
